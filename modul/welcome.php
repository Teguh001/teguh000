  ...
  $htgejala=mysql_query("SELECT count(*) as total from gejala");
	...
	<div class='row'>
        <div class='col-lg-3 col-xs-6'>
          <!-- small box -->
          <div class='small-box bg-Orange Red'>
            <div class='inner'>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <img src="aset/banner/s1 dbm.jpg" alt="First slide">
                    <div class="carousel-caption">
                    </div>
                  </div>
                  <div class="item">
                    <img src="aset/banner/S2 dbm.jpg" alt="Second slide">
                    <div class="carousel-caption">
                    </div>
                </div> 
            ...
            <div class="row">
                <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeIn;">
                    <div class="single-service">
                            ...
                            <img src="aset/banner/icon11.png" alt="">
                      
                        <h2>Aplikasi Responsif</h2>
                        <p>Aplikasi ini dapat menyesuaikan perangkat anda, aplikasi ini dapat di buka di perangkat web pc maupun mobile web.</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="600ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 600ms; animation-name: fadeIn;">
                    <div class="single-service">
                            ...
                            <img src="aset/banner/icon12.png" alt="">
                        
                        <h2>Sahabat belajar</h2>
                        <p>Sistem Pakar ini terus akan terus kami kembangkan mulai dari penambahan pakar dan jenis penyakit diabetes lainyya, supaya akurasi terhadap penyakit yang diderita dapat lebih akurat dan dapat mendeteksi jenis penyakit diabetes lainnya.</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="900ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 900ms; animation-name: fadeIn;">
                    <div class="single-service">
                            <img src="aset/banner/icon13.png" alt="">
                        <h2>Admin Pakar</h2>
