...
<html><head>
    ...
    <base href="http://localhost/sispak_dbm/">
	<link rel="icon" href="gambar/admin/doctor.png">
  ...
  <body id="pakardiabetes" class="hold-transition skin-red-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i  class="fa fa-caret-right" aria-hidden="true"></i>DBM</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i  class=" fa fa-caret-left" aria-hidden="true"></i>Diabetes Melitus</b></span>
        </a>
        <!-- Header Navbar -->
                ...
                if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="gambar/admin/adminku.png" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                      <span class="hidden-xs"><?php echo $user; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                        <img src="gambar/admin/adminku.png" class="img-circle" alt="User Image">
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari SPD</small>
                        </p>
                      </li>
      ...
      <div class="content-wrapper" style="min-height: 310px;">
        ...
        <strong><div class="cinta">Copyright © 2021 - Made with <i class="fa fa-heart pulse"></i> by Kelompok 5</a></div></strong>
      </footer>
